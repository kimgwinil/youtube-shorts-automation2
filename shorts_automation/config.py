...
def load_config(project_root: Path) -> AppConfig:
    ...
    return AppConfig(
        ...
        background_dir=Path(os.environ["BACKGROUND_DIR"]),
        music_dir=project_root / "content" / "music",
        quotes_file=project_root / "content" / "quotes.yaml",
        ...
        shorts_hashtags=os.environ.get("SHORTS_HASHTAGS", "#쇼츠 #명언"),
